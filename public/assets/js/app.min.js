...
/* src/svelte/components/logo.svelte generated by Svelte v3.29.4 */
...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			img_1 = element("img");
			if (img_1.src !== (img_1_src_value = "/assets/img/dbushell-logo.svg")) attr_dev(img_1, "src", img_1_src_value);
...
/* src/svelte/components/contact.svelte generated by Svelte v3.29.4 */
...
function create_else_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(label1, file$1, 73, 8, 1860);
			...
			add_location(input1, file$1, 74, 8, 1933);
			add_location(li1, file$1, 72, 6, 1847);
			attr_dev(label2, "class", "Cursive");
			attr_dev(label2, "for", "contact-enquiry");
			add_location(label2, file$1, 84, 8, 2165);
			...
			add_location(textarea, file$1, 85, 8, 2234);
			add_location(li2, file$1, 83, 6, 2152);
			...
			add_location(path, file$1, 101, 12, 2663);
			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
			attr_dev(svg, "width", "24");
			attr_dev(svg, "height", "24");
			attr_dev(svg, "viewBox", "0 0 24 24");
			add_location(svg, file$1, 96, 10, 2519);
			add_location(span0, file$1, 106, 10, 2895);
			attr_dev(h4, "class", "Privacy");
			add_location(h4, file$1, 95, 8, 2488);
			add_location(small0, file$1, 109, 10, 2966);
			add_location(p1, file$1, 108, 8, 2952);
			attr_dev(a, "href", "/privacy/");
			attr_dev(a, "target", "_blank");
			add_location(a, file$1, 118, 12, 3241);
			add_location(small1, file$1, 116, 10, 3202);
			add_location(p2, file$1, 115, 8, 3188);
			...
			add_location(input2, file$1, 123, 10, 3427);
			add_location(span1, file$1, 132, 10, 3680);
			attr_dev(label3, "class", "Checkbox");
			attr_dev(label3, "for", "contact-privacy");
			add_location(label3, file$1, 122, 8, 3370);
			add_location(li3, file$1, 94, 6, 2475);
			attr_dev(button, "class", "Button");
			attr_dev(button, "type", "submit");
			button.disabled = button_disabled_value = !/*isLive*/ ctx[2];
			add_location(button, file$1, 136, 8, 3791);
			add_location(li4, file$1, 135, 6, 3778);
			attr_dev(label4, "for", "contact-human");
			add_location(label4, file$1, 141, 8, 3935);
			...
			add_location(input3, file$1, 144, 8, 4042);
			attr_dev(li5, "class", "Hidden");
			add_location(li5, file$1, 140, 6, 3907);
