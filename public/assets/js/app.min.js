...
/* src/svelte/components/logo.svelte generated by Svelte v3.35.0 */
const file$1 = "src/svelte/components/logo.svelte";
...
function create_else_block$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(img_1, file$1, 24, 4, 482);
		},
...
function create_fragment$1(ctx) {
	...
	function select_block_type(ctx, dirty) {
		if (/*svg*/ ctx[1]) return create_if_block$1;
	...
	const block = {
		c: function create() {
			...
			add_location(span, file$1, 20, 2, 404);
			attr_dev(a, "href", "/");
			attr_dev(a, "class", "Logo");
			add_location(a, file$1, 19, 0, 376);
		},
...
/* src/svelte/components/contact.svelte generated by Svelte v3.35.0 */
const file = "src/svelte/components/contact.svelte";
...
function create_else_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(p0, file, 60, 4, 1524);
			attr_dev(label0, "class", "Cursive");
			attr_dev(label0, "for", "contact-name");
			add_location(label0, file, 63, 8, 1610);
			...
			add_location(input0, file, 64, 8, 1673);
			add_location(li0, file, 62, 6, 1597);
			attr_dev(label1, "class", "Cursive");
			attr_dev(label1, "for", "contact-email");
			add_location(label1, file, 74, 8, 1884);
			...
			add_location(input1, file, 75, 8, 1957);
			add_location(li1, file, 73, 6, 1871);
			attr_dev(label2, "class", "Cursive");
			attr_dev(label2, "for", "contact-enquiry");
			add_location(label2, file, 86, 8, 2213);
			...
			add_location(textarea, file, 87, 8, 2282);
			add_location(li2, file, 85, 6, 2200);
			...
			add_location(path, file, 104, 12, 2735);
			attr_dev(svg, "xmlns", "http://www.w3.org/2000/svg");
			attr_dev(svg, "width", "24");
			attr_dev(svg, "height", "24");
			attr_dev(svg, "viewBox", "0 0 24 24");
			add_location(svg, file, 99, 10, 2591);
			add_location(span0, file, 109, 10, 2967);
			attr_dev(h4, "class", "Privacy");
			add_location(h4, file, 98, 8, 2560);
			add_location(small0, file, 112, 10, 3038);
			add_location(p1, file, 111, 8, 3024);
			attr_dev(a, "href", "/privacy/");
			attr_dev(a, "target", "_blank");
			add_location(a, file, 121, 12, 3313);
			add_location(small1, file, 119, 10, 3274);
			add_location(p2, file, 118, 8, 3260);
			...
			add_location(input2, file, 126, 10, 3482);
			add_location(span1, file, 135, 10, 3746);
			attr_dev(label3, "for", "contact-privacy");
			add_location(label3, file, 125, 8, 3442);
			add_location(li3, file, 97, 6, 2547);
			attr_dev(button, "class", "Button");
			attr_dev(button, "type", "submit");
			button.disabled = button_disabled_value = !/*isLive*/ ctx[2];
			add_location(button, file, 139, 8, 3857);
			add_location(li4, file, 138, 6, 3844);
			attr_dev(label4, "for", "contact-human");
			add_location(label4, file, 144, 8, 4001);
			...
			add_location(input3, file, 147, 8, 4108);
			attr_dev(li5, "class", "Hidden");
			add_location(li5, file, 143, 6, 3973);
			attr_dev(ul, "class", "Form");
			add_location(ul, file, 61, 4, 1573);
			attr_dev(form, "method", "post");
			attr_dev(form, "action", "/contact/");
			add_location(form, file, 59, 2, 1459);
		},
		m: function mount(target, anchor) {
...
function create_if_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(strong, file, 53, 4, 1325);
			attr_dev(p, "class", "Error");
			add_location(p, file, 52, 2, 1303);
		},
		m: function mount(target, anchor) {
...
function create_if_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(strong, file, 49, 4, 1198);
			add_location(p, file, 48, 2, 1190);
		},
		m: function mount(target, anchor) {
			insert_dev(target, p, anchor);
			append_dev(p, strong);
...
function create_fragment(ctx) {
	...
	function select_block_type(ctx, dirty) {
		if (/*isSuccess*/ ctx[0]) return create_if_block;
